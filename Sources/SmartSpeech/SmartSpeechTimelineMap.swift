...
struct SmartSpeechTimelineMap: Codable, Sendable, Equatable {
...
/// Accumulates a global `SmartSpeechTimelineMap` across chapter chunks. Each chunk's segments are in
...
struct SmartSpeechTimelineMapBuilder {
    private var points: [SmartSpeechTimelineMap.Point] = []
    ...
    private mutating func add(_ p: SmartSpeechTimelineMap.Point) {
    ...
    func finish(sourceDuration: TimeInterval, trimmedDuration: TimeInterval) -> SmartSpeechTimelineMap {
        SmartSpeechTimelineMap(points: points, sourceDuration: sourceDuration, trimmedDuration: trimmedDuration)
    }
}
...
struct SmartSpeechChapterMark: Codable, Sendable, Equatable {
    var title: String
